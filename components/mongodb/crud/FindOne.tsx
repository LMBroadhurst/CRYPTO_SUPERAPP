...
const FindOne = () => {
  ...
  return (
    <section>
      <p>
        Currently connected via the mongodb node driver to a sample database
        called "sample_analytics".
      </p>
      <p>
        Sample analytics contains 3 collections, named "accounts", "customers",
        and "transactions".
      </p>
      <p>
        To view a document from each collection, click the correct command for
        finding 1 document in a collection below!
      </p>
      ...
      <p>
        The syntax of the findOne method allows you to filter for exact matches
        of properties, or use comparators.
      </p>
