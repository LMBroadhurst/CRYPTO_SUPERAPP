    ...
    <section className='flex p-10 lg:p-0 lg:w-full'>
        <section className='flex flex-col gap-5'>
            ...
            <section className='flex flex-col gap-5 text-slate-500'>
              ...
              <p>Outside of work, I spend my time trying out new languages and programming paradigms, blogging about Web3, lifting weights in a gym that needs far better AC, and roaming around London.</p>
            </section>
