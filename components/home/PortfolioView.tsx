...
const contentToRender: CardContents[] = [
  {
    ...
    description: <p>As I have become fluent using React, I wanted to push myself to cover bases and knowledge gaps I may have missed along the way. I have been following Kent from my first JS conference, where he did a short  talk on Remix. I knew Kent had an intermediate-advanced react course so I decided to check it out, since he kindly has open sourced the course materials.<br/><br/>After going through the materials this guy knows React inside out! Massively helped me improve my understanding of the React fundamentals & 'how to think in React', given me new paradigms of how I should be coding in React, and gave me more exposure to testing with Jest, RTL, and MSW.</p>,
    date: 'Sep 2023',
    image: KENTCDODDS,
...
const Portfolio = () => {
  ...
  return <section className='mb-32 lg:mb-0'>
    <section className='flex flex-col gap-2 p-10 lg:p-0'>
      ...
      <section className='flex flex-col gap-5 text-slate-400 text-justify'>
        ...
        <p>Welcome to my portfolio! Whilst not all of these are projects per se, I thought it would be good to share some of the courses and things I've been getting up to outside of work 😄</p>
