  ...
  return (
    <nav className='hidden lg:flex'>
        <ul className='flex flex-col gap-2 text-lg items-start text-slate-500'>
          ...
          <button className='flex items-center gap-2 duration-200 transition-all hover:text-orange-600 hover:cursor-not-allowed hover:translate-x-0.5'>Blog <ExportOutlined /></button>
        </ul>
    </nav>
  )
}
