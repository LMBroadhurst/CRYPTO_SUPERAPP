        ...
        <SectionContainer vh={85}>
            ...
            <section className='flex flex-col gap-5 lg:gap-4 xl:gap-6'>
                <section className='flex flex-col gap-2 text-left lg:gap-4 xl:gap-6'>
                    ...
                    <p className='text-2xl lg:text-3xl'>Where I build apps, talk about tech, and experiment with code & coding paradigms.</p>    
                </section>

                <section className='self-stretch flex flex-row lg:justify-start gap-4'>
                    <button className='border-2 py-2 px-8 rounded-xl'>Blog</button>
                    <button className='border-2 bg-white text-gray-800 py-2 px-8 rounded-xl'>Apps</button>
                </section>
            </section>
        </SectionContainer>
    )
