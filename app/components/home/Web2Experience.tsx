...
const Experience: React.FC = () => {
    ...
    return (
        <SectionContainer vh={100} isLeftToRight={false}>
            ...
            <section className="flex flex-col gap-2">
                ...
                <section className="flex flex-col mt-4">
                    <div className='flex flex-row gap-4 text-lg sm:text-xl'>
                        <button className='border py-2 px-8 rounded-xl'>Web2 Development</button>
                        <button className='border bg-white text-gray-800 py-2 px-8 rounded-xl'>Web3 Audit </button>
                    </div>
                </section>
            </section>
        </SectionContainer>
...
{/* <h3 className='text-2xl lg:text-3xl xl:text-4xl'>Everything on this website has been custom built and designed by me, using my favourite bits of tech.</h3> */}
