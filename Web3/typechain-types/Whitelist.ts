...
export interface WhitelistInterface extends utils.Interface {
  functions: {
    ...
    "numberOfAddressesWhitelisted()": FunctionFragment;
  ...
  encodeFunctionData(
    functionFragment: "numberOfAddressesWhitelisted",
    values?: undefined
  ): string;
  encodeFunctionData(
...
export interface Whitelist extends BaseContract {
  ...
  functions: {
    ...
    numberOfAddressesWhitelisted(overrides?: CallOverrides): Promise<[number]>;
  ...
  estimateGas: {
    ...
    numberOfAddressesWhitelisted(overrides?: CallOverrides): Promise<BigNumber>;
